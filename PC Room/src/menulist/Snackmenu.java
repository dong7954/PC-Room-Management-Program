...
public class Snackmenu  extends JPanel {
	...
	JLabel LabelResult;//총합구하는 라벨
	  ...
	  int count = 0;
	    ...
	    JTable table;
	    ImageIcon[] img = { 
	            new ImageIcon("Image/snack1.png"),
	            new ImageIcon("Image/snack2.png"),
 ...
 ok[i].addActionListener(new ActionListener() { 
     ...
     public void actionPerformed(ActionEvent e) {
        ...
        /* for (int i = 0; i<me.table.getRowCount(); i++){ 
         ...
         String menuDB[] = {"Sunchip", "Ojingchip"
         };
	...
	public void Snackmenu(int a, DataOutputStream out) {
		PcNum = a;
		Queryout = out;
	}
