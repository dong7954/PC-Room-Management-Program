...
public class Instantmenu  extends JPanel{
	...
	JLabel LabelResult;//총합구하는 라벨
	  ...
	  DataOutputStream Queryout;
	    ...
	    String show = "";
	    String menu[] = { "왕교자만두", "얇피만두" };
	    int price[] = { 3000,4000 };

	    JTable table;
	    ImageIcon[] img = { 
	            new ImageIcon("Image/instant1.png"),
	            new ImageIcon("Image/instant2.png"),
 ...
 ok[i].addActionListener(new ActionListener() { 
     ...
     public void actionPerformed(ActionEvent e) {
        ...
        /* for (int i = 0; i<me.table.getRowCount(); i++){ 
         ...
         //Menu Mainmenu = new Menu(sum);
         System.out.println(count);
         
         
         
         String menuDB[] = {"Wanggyoja", "Ralpee"
         };
	...
	public void Instantmenu(int a, DataOutputStream out) {
		PcNum = a;
		Queryout = out;
	}
